package Mojolicious::Plugin::PDFMerge::Data;

# ABSTRACT: model for Mojolicious::Plugin::PDFMerge
# VERSION
...
sub links
{
  [ { href => 'https://github.com/plicease/Mojolicious-Plugin-PDFMerge', text => '@github' } ];
}

sub version
{
  $Mojolicious::Plugin::PDFMerge::VERSION // 'dev';
}

sub footer
{
  my($self) = @_;
  'Mojolicious::Plugin::PDFMerge version ' . $self->version . ' copyright &copy; 2012 Graham Ollis';
}
